    ...
    for i in range(num):
        ...
        while True:
            ...
            try:
                ...
                print(base_uri + " not responding yet (BaseHTTPError: " + str(e) + "). waiting for start up...")
                time.sleep(5)
            except requests.exceptions.ConnectionError as e:
                # this happens when the server refuses any connection yet
                print(base_uri + " not responding yet (ConnectionError: " + str(e) + "). waiting for start up...")
                time.sleep(5)
...
# wait (1 second for each container for initial startup)
time.sleep(1 * ARGS.num)
